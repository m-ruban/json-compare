    ...
    <Col xs={8}>
      <ListGroup>
        <ListGroupItem>
          ...
          <ListGroupItemText>
            This tool is being used for studying the <b>JSON</b> object
            hierarchy and comparing two <b>JSON</b> objects.
            <br />
            Also, in the presence of the possibility of comparing two{' '}
            <b>JSON</b> objects.
          </ListGroupItemText>
        </ListGroupItem>
        <ListGroupItem>
