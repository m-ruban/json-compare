          ...
          <Col xs={8}>
            <ListGroup>
              <ListGroupItem>
                ...
                <ListGroupItemText>
                  This tool can be used to study the <b>JSON</b> object hierarchy.<br /> Also, in the presence of the possibility of comparing two <b>JSON</b> objects.
                </ListGroupItemText>
              </ListGroupItem>
              <ListGroupItem>
                ...
                <ListGroupItemText>
                  ...
                  3) <b>Ignore</b> - the application ignore value
                </ListGroupItemText>
              </ListGroupItem>
              <ListGroupItem>
                ...
                <ListGroupItemText>
                  ...
                  <Badge color="diff" pill>!</Badge> - the key is present, but the value does not match<br />
                </ListGroupItemText>
              </ListGroupItem>
            </ListGroup>
          </Col>
